...
from generated import ping_pb2 as ping__pb2
...
class PingServiceStub:
    """A no-op service that exists only to prove the transport works.
    No auction logic lives here, and none ever will.
    """
